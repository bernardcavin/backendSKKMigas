        ...
        for j in range(random.randint(0,10)):
            ...
            if job_type in [JobType.EXPLORATION, JobType.DEVELOPMENT]:
                ...
                if job_type == JobType.EXPLORATION:
                    ...
                    job_plan_schema = job_crud.CreateActualExploration
                    actual_work_schema = ActualExploration
                else:
                    work_schema = job_crud.DevelopmentJobPlan
                    job_plan_schema = job_crud.CreateActualDevelopment
                ...
                if job_type == JobType.WORKOVER:
                    ...
                    job_actual_schema = job_crud.CreateActualWorkover
                    actual_work_schema = ActualWorkover
                else:
                    work_schema = job_crud.WellServiceJobPlan
                    job_actual_schema = job_crud.CreateActualWellService
