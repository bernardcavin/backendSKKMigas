from app.routers.auth.models import User, KKKS
...
models = [Eksplorasi,Eksploitasi,Workover,WellService,LogPekerjaan, User, KKKS, Pengajuan, Operasi, PPP, CloseOut, Well]
