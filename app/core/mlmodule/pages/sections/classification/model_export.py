...
from app.core.mlmodule.pages.sections.classification.utils import parse_validation_errors, session_get_file_path, continue_button, reset_button
...
def layout():
    ...
    layout = dmc.Stack(
        [
            ...
            dmc.Button("Download", color="green", id='classification-apply_model_export', n_clicks=0),
            html.Div(id="classification-model-export-output"),
            dcc.Download(id="classification-download-model"),
            dmc.Group(
                [
                    reset_button,
                    html.Div(
...
@callback(
    Output("classification-model-export-output", "children"),
    Output("classification-download-model", "data"),
    Input('classification-apply_model_export', 'n_clicks'),
